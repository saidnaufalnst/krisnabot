...
SYSTEM_INSTRUCTION = (
    ...
    "Daftar kolom, field, isian, dokumen lampiran, dan referensi pilihan bukan langkah awal. Letakkan informasi tersebut di Catatan atau sebagai detail setelah langkah mengisi form, jangan sebelum langkah masuk halaman.\n"
    ...
    "Jika rujukan tidak cukup, sampaikan keterbatasannya."
)
